...
public class LegacyImportEventsController {
    private final FetchEventsService fetchService;
    private final NormalizeImportedEventsService normalizeService;
    public LegacyImportEventsController(FetchEventsService fetchService, NormalizeImportedEventsService normalizeService) {
